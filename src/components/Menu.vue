        ...
        <ul class="navbar-nav display-none display-md-flex mr-auto">
          ...
          <li class="nav-item">
            <router-link to="/cart" class="nav-link"
              >Cart ({{ cart.length || 0 }})</router-link
            >
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <router-link to="/orders" class="nav-link">Orders ({{ orderCount || 0 }})</router-link>
          </li>
        </ul>
        <ul class="navbar-nav display-flex align-items-center">
          <div class="dropdown">
            <a
              class="nav-link display-flex align-items-center"
              href="#"
              role="button"
            ...
            <ul class="dropdown-menu">
              <div class="display-block display-lg-none display-md-none">
                ...
                <li>
                  <router-link to="/drinks" class="dropdown-item"
                    >Drinks</router-link
                  >
                </li>
                <li>
      ...
      <div class="container-fluid">
        <div class="row padding__2 pt-3 pb-3 display-flex align-items-center">
          <div class="column-md-2">
            <a
              href="./"
              class="h2 text-decoration-none display-none display-md-flex text-main"
              >Fine Wine</a
            >
          </div>
          ...
          <div class="column-md-2">
            ...
            >
              <span
                class="btn-main text-light cart display-flex align-items-center justify-content-center fs-4 rounded-circle square-42"
...
export default {
  ...
  computed: {
    cart() {
      const data = this.$store.getters["cart/cart"];
